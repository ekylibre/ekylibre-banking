    ...
    module Handlers
      class Cashes
        ...
        def bulk_find_or_create
          Integrations::Banking::Data::BankInformations.new.result.each do |bank_information|
          ...
          def find_and_update_existant_cash(bank_information)
            ...
            if cash.present?
              cash.update!(
                ...
                provider: { vendor: @vendor, name: 'Banking_bank_information',
          ...
          def find_or_create_account(bank_information)
            ...
            if account
              ...
              account = Account.create!(
                ...
                provider: { vendor: @vendor, name: 'Banking_bank_information', data: { id: bank_information[:id].to_s } }
              )
            end
          end
